...
json_endpoint_models = [
    models.Patient, models.BasicInfo, models.LegalGuardian, models.MedicalInfo, models.IdentifyingInfo, models.SelfPreservation, models.Protocol, models.Behavior
]
