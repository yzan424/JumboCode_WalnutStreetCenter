...
default_methods = ('GET', 'PUT', 'POST', 'DELETE', 'PATCH')
json_endpoint_models = [
    models.Patient, models.BasicInfo, models.LegalFamilyInfo, models.MedicalInfo, models.IdentifyingInfo, models.SelfPreservation, models.Protocol, models.Behavior
]
